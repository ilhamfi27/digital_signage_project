        ...
        <div class="box-body">
          <?= form_open_multipart('add_ons_new/new_addon',['class' => 'form-horizontal']) ?>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="ratings" name="plugins[ratings]">
                <?= form_error('plugins[ratings]')?>
              </div>
           </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" id="date" name="plugins[date]">
                <?= form_error('plugins[date]')?>
              </div>
            </div>
              ...
              <div class="col-sm-10">
                <select name="id_creator" class="form-control">
                  <?php foreach ($creator as $c): ?>
                    <option value="<?php echo $c->id_creator ?>"><?php echo $c->name ?></option>
                  <?php endforeach ?>
                </select>
