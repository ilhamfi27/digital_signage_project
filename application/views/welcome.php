...
<head>
    ...
    <title>Welcome to D'Digital Signage</title>
    ...
    <link href="<?= base_url() ?>assets/vendor/template_creative/css/creative.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">D'Digital Signage</a>
    ...
    <script src="<?= base_url() ?>assets/vendor/bootstrap_v4/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="<?= base_url() ?>assets/vendor/template_creative/js/creative.min.js"></script>
