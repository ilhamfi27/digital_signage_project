    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <?= form_open('Front_display/content')?>
			<table>
				<tr>
					<td>Content 1</td>
					<td>:</td>
					<td><?=form_dropdown('content1',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
					<td>Content 2</td>
					<td>:</td>
					<td><?=form_dropdown('content2',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
					<td>Content 3</td>
					<td>:</td>
					<td><?=form_dropdown('content3',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
					<td>Content 4</td>
					<td>:</td>
					<td><?=form_dropdown('content4',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
					<td>Content 5</td>
					<td>:</td>
					<td><?=form_dropdown('content5',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
					<td>Content 6</td>
					<td>:</td>
					<td><?=form_dropdown('content6',$dropdown_data,NULL)?></td>
				</tr>
				<tr>
